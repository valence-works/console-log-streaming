...
public sealed class ConsoleLogOptions
{
    ...
    /// <summary>
    /// Capacity of the asynchronous capture publish queue.
    /// </summary>
    public int CaptureChannelCapacity { get; set; } = 1000;
    ...
    /// <summary>
    /// Marks sources stale when they have not emitted output within this period.
    /// </summary>
    ...
    /// <summary>
    /// Replacement used when a configured rule redacts a value.
    /// </summary>
    ...
    /// <summary>
    /// Metadata or source property names whose values should be fully redacted.
    /// </summary>
