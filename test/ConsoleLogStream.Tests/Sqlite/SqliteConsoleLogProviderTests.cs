...
using ConsoleLogStream.Persistence.Sqlite;
using ConsoleLogStream.Persistence.Sqlite.DependencyInjection;
using Microsoft.Extensions.DependencyInjection;

namespace ConsoleLogStream.Tests.Sqlite;
...
public sealed class SqliteConsoleLogProviderTests
{
    ...
    private static ServiceProvider CreateServices(string connectionString, Action<SqliteConsoleLogOptions>? configure = null)
    {
        return new ServiceCollection()
            .AddConsoleLogStream(options => options.SourceId = "sqlite-test")
            .AddConsoleLogStreamSqlite(options =>
            {
